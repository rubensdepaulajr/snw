<%@ Page Language="C#" MasterPageFile="~/Atz.master" AutoEventWireup="true" CodeFile="fhapci.aspx.cs" Theme="Standard" Inherits="Atz_fhapci" Title="Ficha do Paciente" %>
                                        ...
                                        <tr>
                                            <td style="padding-right: 0px; padding-left: 40px; padding-bottom: 0px; padding-top: 0px">
                                                <asp:ImageButton id="btnSolItn" runat="server" Visible="False" 
                                                     ImageUrl="~/Images/bt_internacao.gif" border="0" alt="" height="39" 
