<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupTemplate.aspx.cs" Theme="Standard" Inherits="Atz_popupTemplate" %>
               ...
               <asp:GridView ID="grd" runat="server" AllowPaging="True"  
                ...
                ondatabound="grd_DataBound" onselectedindexchanged="grd_SelectedIndexChanged">
                    ...
                    <Columns>
		                                ...
		                                <asp:BoundField DataField="Bnf_UltAtd" HeaderText="Ult.Atendimento" SortExpression="Bnf_UltAtd" />
		                                <asp:BoundField DataField="Bnf_Sxo" HeaderText="Sexo" SortExpression="Bnf_Sxo" />
