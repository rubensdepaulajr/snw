<%@ Page Language="C#" MasterPageFile="~/Atz.master" AutoEventWireup="true" CodeFile="sgncrd.aspx.cs" 
Inherits="Sgn_sgncrd" Title="Gerenciar Usuários" %>
                                ...
                                <tr>
                                    <td>
                                        <asp:RadioButtonList ID="rblTipAco" runat="server" CssClass="azulescuropequeno" RepeatDirection="Horizontal">
                                            ...
                                            <asp:ListItem Value="GrpDsc">Grupo</asp:ListItem>
                                            <asp:ListItem Value="PplDsc">Papel</asp:ListItem>
                                        </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="vermelhonormal" style="height: 26px">
                                            <asp:DropDownList ID="ddlPpl" runat="server" DataSourceID="dtsPpl" DataTextField="Ppl_Dsc"
                                                ...
                                                SelectCommand="SELECT [IdPpl], [Ppl_Dsc] FROM [Sgn_Ppl] WHERE Ppl_Ope = 0 ORDER BY [Ppl_Dsc]"></asp:SqlDataSource>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 26px">
