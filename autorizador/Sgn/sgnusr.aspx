<%@ Page Language="C#" MasterPageFile="~/Atz.master" AutoEventWireup="true" CodeFile="sgnusr.aspx.cs" 
Inherits="Sgn_sgnusr" Title="Gerenciar Usuários" %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="vermelhonormal" style="height: 26px">
                                            <asp:DropDownList ID="ddlPpl" runat="server" DataSourceID="dtsPpl" DataTextField="Ppl_Dsc"
                                                ...
                                                SelectCommand="SELECT [IdPpl], [Ppl_Dsc] FROM [Sgn_Ppl] ORDER BY [Ppl_Dsc]"></asp:SqlDataSource>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 26px">
