...
public partial class Ngc_atzpdm : System.Web.UI.Page
{
    ...
    protected void grd_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        chkPdmEsp.Checked = cb2.Checked;
        CheckBox cb3 = (CheckBox)(grd.SelectedRow.FindControl("chkPrf"));
        chkPdmPrf.Checked = cb3.Checked;
        CheckBox cb4 = (CheckBox)(grd.SelectedRow.FindControl("chkAtv"));
        chkPdmAtv.Checked = cb4.Checked;
        CheckBox cb5 = (CheckBox)(grd.SelectedRow.FindControl("chkBlqUrg"));
        chkPdmBlqUrg.Checked = cb5.Checked;

        ddlPdmSxo.SelectedValue = grd.SelectedRow.Cells[16].Text.Trim();
        txtPdmIddMin.Text = HttpUtility.HtmlDecode(grd.SelectedRow.Cells[17].Text).Trim();
        txtPdmIddMax.Text = HttpUtility.HtmlDecode(grd.SelectedRow.Cells[18].Text).Trim();
        txtPdmQtdMax.Text = HttpUtility.HtmlDecode(grd.SelectedRow.Cells[19].Text).Trim();
        txtPdmQtdDia.Text = HttpUtility.HtmlDecode(grd.SelectedRow.Cells[20].Text).Trim();
        txtPdmQtdMes.Text = HttpUtility.HtmlDecode(grd.SelectedRow.Cells[21].Text).Trim();
        txtPdmQtdAno.Text = HttpUtility.HtmlDecode(grd.SelectedRow.Cells[22].Text).Trim();
        txtPdmRtn.Text = HttpUtility.HtmlDecode(grd.SelectedRow.Cells[23].Text).Trim();    
    }
