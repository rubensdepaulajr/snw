<%@ Page Language="C#" MasterPageFile="~/Atz.master" AutoEventWireup="true" CodeFile="atzpdm.aspx.cs" 
    Inherits="Ngc_atzpdm" Title="Cadastro de Procedimentos" %>
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
                ...
                <div id="divInf">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                Pode solicitar na Internação?</td>
                            <td>            
                                <asp:CheckBox ID="chkPdmItn" runat="server" />
                            </td>
                        </tr>  
                        <tr>
            ...
            <asp:GridView id="grd" runat="server" Width="100%" Font-Size="X-Small" PageSize="20" 
                ...
                <Columns>                    
                    ...
                    <asp:BoundField DataField="Pdm_QtdFlm" HeaderText="Qtd.Filme" SortExpression="Pdm_QtdFlm">
                        ...
                        <asp:TemplateField HeaderText="Internação" SortExpression="Pdm_Itn"><EditItemTemplate>
                            <asp:CheckBox runat="server" Checked='<%# Bind("Pdm_Itn") %>' id="CheckBox5"></asp:CheckBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:CheckBox id="ChkItn" runat="server" Enabled="false" Checked='<%# Bind("Pdm_Itn") %>'></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <UpdateParameters>
                ...
                <asp:ControlParameter ControlID="chkPdmItn" PropertyName="Checked" Name="Pdm_Itn" Type="Boolean"></asp:ControlParameter>
