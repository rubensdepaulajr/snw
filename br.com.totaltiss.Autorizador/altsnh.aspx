<%@ Page Language="C#" MasterPageFile="~/Raiz.master" AutoEventWireup="true" Inherits="altsnh" Title="Alterar Senha" Codebehind="altsnh.aspx.cs" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
     <ContentTemplate>
        ...
        <div style="padding: 40px 0 0px 20px; text-align: center;">
            &nbsp;</div>
        ...
        <table align="left" border="0" cellpadding="0" cellspacing="0">
            ...
            <asp:Label
                ID="lblErr" runat="server" CssClass="erro"></asp:Label></td>
											...
											<tr>
												...
												<td width="5"></td>
												<td align="left" style="width: 139px"><span class="cinza-escuro">
											...
											<tr>
												...
												<td width="5"></td>
												<td align="left" style="width: 139px"><span class="cinza-claro">
            ...
            <tr><td class="campo" style="width: 149px">&nbsp;</td><td colspan="2" height="35px"  valign="top">
                &nbsp;&nbsp;
                <asp:ImageButton ID="btnAltSnh" runat="server" ImageUrl="~/Images/bt_alterar_senha.gif" OnClick="btnAltSnh_Click" />&nbsp;<asp:ImageButton
                    ID="btnPgaIni" runat="server" ImageUrl="~/Images/bt_home.gif" OnClick="btnPgaIni_Click" /></td></tr>	                                   								                                                
