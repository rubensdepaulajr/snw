<%@ Page Language="C#" MasterPageFile="~/Atz.master" AutoEventWireup="true" Inherits="Atz_auditn" Theme="Standard" Title="Página Inicial de Atendente - Solicitações Autorizadas" Codebehind="auditn.aspx.cs" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:GridView id="grdItn" runat="server"
                                    ...
                                    DataKeyNames="IdItn">
                                <Columns>
                                    <asp:BoundField DataField="Gia_IdCtt" HeaderText="Contratado" 
                                        SortExpression="Gia_IdCtt"></asp:BoundField>
                                    <asp:BoundField DataField="Gia_SeqEnd" HeaderText="Seq.End." 
                                        SortExpression="Gia_SeqEnd"></asp:BoundField>
                                    <asp:HyperLinkField DataNavigateUrlFields="IdItn" DataNavigateUrlFormatString="auditndet.aspx?Itn={0}"
                                    ...
                                    <asp:BoundField DataField="Gia_DatItn" HeaderText="Internação" 
                                        SortExpression="Gia_DatItn" />
                                    <asp:BoundField DataField="Itn_Dri" HeaderText="Diárias" ReadOnly="True" 
                                        SortExpression="Itn_Dri" />
                                    <asp:BoundField DataField="Itn_Tip" HeaderText="Tipo" 
                                        SortExpression="Itn_Tip" ReadOnly="True"></asp:BoundField>
                                    <asp:BoundField DataField="Sit_Dsc" HeaderText="Situação" 
                                        SortExpression="Itn_Sit" ReadOnly="True"></asp:BoundField>
                                </Columns>
                                <PagerTemplate>
