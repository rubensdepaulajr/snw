<%@ Page Language="C#" MasterPageFile="~/atz.master" AutoEventWireup="true"  Theme="Standard" Inherits="Atz_solitn" Title="Solicitação Internação" Codebehind="solitn.aspx.cs" %>
...
<tbody>
    ...
    <tr>
        ...
        <tr>
            ...
            <td width="5"></td>
            <td align="left">
                <asp:TextBox runat="server" ID="txtLoc" CssClass="campo" MaxLength="50" 
        ...
        <tr>
            ...
            <td valign="middle" >
                <asp:Label ID="txtDatEms" runat="server" Enabled="False" Width="111px"></asp:Label>
                &nbsp; Hora:
                <asp:TextBox ID="txtHor" runat="server" CssClass="campo" Width="35px"></asp:TextBox>
                &nbsp;:&nbsp;
                <asp:TextBox ID="txtMin" runat="server" CssClass="campo" Width="35px"></asp:TextBox>
                <ajaxToolkit:NumericUpDownExtender ID="nudTxtHor" runat="server" Maximum="23" 
                    Minimum="0" TargetControlID="txtHor" Width="50">
                </ajaxToolkit:NumericUpDownExtender>
                <ajaxToolkit:NumericUpDownExtender ID="nudTxtMin" runat="server" Maximum="59" 
                    Minimum="0" TargetControlID="txtMin" Width="50">
                </ajaxToolkit:NumericUpDownExtender>
                <ajaxToolkit:FilteredTextBoxExtender ID="fteTxtHor" runat="server" FilterType="numbers" 
                    TargetControlID="txtHor">
                </ajaxToolkit:FilteredTextBoxExtender>
                <ajaxToolkit:FilteredTextBoxExtender ID="fteTxtMin" runat="server" FilterType="numbers" 
                    TargetControlID="txtMin">
                </ajaxToolkit:FilteredTextBoxExtender>
                &nbsp;<asp:Image ID="imgAjudaDatHorSolExa" runat="server" 
                    ImageUrl="~/Images/ico_ajuda_campos.gif" />
            </td>
        </tr>
        <tr>
